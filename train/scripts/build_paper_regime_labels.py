#!/usr/bin/env python3
"""Phase 1: paper-aligned 5-regime labels on the evaluation date range.

Offline labels may use the full evaluation sample. The MVO backtest still
refits the HMM causally at each rebalance.
"""
...
from paper_hmm import identify_regimes_paper  # noqa: E402
...
def main() -> int:
    ...
    labels, diagnostics = identify_regimes_paper(
    ...
    label_path = output_dir / "regime_labels_paper_5.csv"
    center_path = output_dir / "regime_vol_centers.npy"
    meta_path = output_dir / "regime_labels_paper_5.meta.json"
    ...
    metadata = {
        ...
        "note": (
            "Offline labels on the evaluation sample. Rolling MVO still refits "
